...
const createLegalDocuments = async () => {
  try {
    ...
    const termsDocument = new LegalDocument({
      ...
      metaTitle: 'Terms of Use - Silver Surfers',
      metaDescription: 'Terms and conditions for using Silver Surfers accessibility audit services',
    ...
    const privacyDocument = new LegalDocument({
      ...
      status: 'published',
      effectiveDate: new Date(),
      metaTitle: 'Privacy Policy - Silver Surfers',
      metaDescription: 'Privacy policy explaining how we collect, use, and protect your information',
    ...
    console.log('   - /legal/terms-of-use');
